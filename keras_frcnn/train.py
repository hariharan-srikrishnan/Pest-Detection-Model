...
def train_kitti():
    ...
    cfg.model_path = '/content/gdrive/My Drive/PS-1/keras_frcnn/model/kitti_frcnn_last.hdf5'
    #cfg.simple_label_file = 'kitti_simple_label.txt'
    cfg.simple_label_file = '/content/gdrive/My Drive/PS-1/keras_frcnn/FAW_file.txt'
